...
public class BilibliUpLoad {
                    ...
                    try {
                        ...
                        for (WebElement element:elements){
                            ...
                            if ("上传完成".equals(flag)) {
                                ...
                                LOGGER.info("获取异常");
                                LOGGER.info("upload flag is null  :{}",this.groupId);
                                return;
                                ...
                                WebDriverHelp.sleep(3);
                                LOGGER.debug("{},{}",this.groupId, flag);
                            }
                        }
     ...
     * @param object
     */
    private void initStart(JSONObject object) {
        ...
        this.groupId=fileInfoList.get(0).getGroupId();
        LOGGER.info("upload start :{}",this.groupId);
    }
    ...
    class Action {
        public Action action(motion m, int i, String msg) {
            ...
            try {
                ...
                LOGGER.info("{}:动作执行异常:{},{}",msg,e.getClass().getSimpleName(),groupId);
            ...
            LOGGER.info("{},动作执行时间:{},{}",msg, System.currentTimeMillis() - start,groupId);
